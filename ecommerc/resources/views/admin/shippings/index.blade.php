...
@endif
  <div class="box">
    ...
    <div class="box-body">
      <form class="delete-from" action="{{aurl('shippings/destroy/all')}}" method="post">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" name="button" class="btn btn-danger delete-all">DeleteAll Shippings</button>
      </div>
    </div>
