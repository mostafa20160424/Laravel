...
use App\Shipping;//model that will read and insert  from him
...
class ShippingDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
      //php artisan datatables:make name
        return datatables($query)
            ->addColumn('edit', 'admin.shippings.action.edit')//addColumn(name,view path)
            ->addColumn('delete', 'admin.shippings.action.delete')//addColumn(name,view path)
            ->addColumn('checkbox', 'admin.shippings.action.checkbox')//addColumn(name,view path)
    ...
    protected function getColumns()
    {
        ...
        return [
          ...
          [
            'name'=>'name_ar',//column name
            'data'=>'name_ar',//column name in database
            'title'=>trans('admin.name_ar'),
          ],
          [
            'name'=>'name_en',//column name
            'data'=>'name_en',//column name in database
            'title'=>trans('admin.name_en'),
          ],

            [
                'name'=>'user_id.name',//column name
                'data'=>'user_id.name',//column name in database
